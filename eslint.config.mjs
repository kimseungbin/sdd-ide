...
export default [
    ...
    rules: {
      'no-restricted-syntax': [
        ...
        },
        {
          ...
          message:
            'Use the <Input> component, not a raw <input> (CLAUDE.md Rule 3). Raw <input> is allowed only in components/Input/.',
        },
      ],
    },
  },
  {
    ...
    files: [
      ...
      'src/renderer/src/components/Textarea/**',
      'src/renderer/src/components/Input/**',
    ],
    rules: {
